    ...
    public static class Addin
    {
        ...
        public class RibbonController : ExcelRibbon, IExcelAddIn
        {
            ...
            public override string GetCustomUI(string RibbonID)
            {
                ...
                str += "</group>";
                str += "<group id='xltrailWorkbookInfo' label='Workbook' getVisible='GetWorkbookVisibility'>\n";
                str += "<button id='repositoryName' getLabel='GetRepositoryName' size='normal' imageMso='Info' getSupertip='GetRepositoryUrl' />\n";
                str += "<button id='workbookName' getLabel='GetWorkbookName' size='normal' imageMso='Info' />\n";
                str += "</group>";
                str += "<group id='xltrailVersionInfo' label='Version' getVisible='GetWorkbookVisibility'>\n";
                str += "<button id='branchName' getLabel='GetBranchName' size='normal' imageMso='Info' />\n";
                str += "<button id='lastModified' getLabel='GetLastModified' size='normal' imageMso='Info' />\n";
            ...
            public string GetWorkbookName(IRibbonControl control)
            {
                if (activeWorkbookBranch == null)
                    return "";
                return "Workbook: " + activeWorkbookBranch.Workbook.Path;
            }
            ...
            public string GetRepositoryName(IRibbonControl control)
            {
                if (activeWorkbookBranch == null)
                    return "";
                return "Repository: " + activeWorkbookBranch.Workbook.Repository.Name; //activeWorkbookBranch.Workbook.Repository.Url;
            }

            public string GetRepositoryUrl(IRibbonControl control)
            {
                if (activeWorkbookBranch == null)
                    return "";
                return activeWorkbookBranch.Workbook.Repository.Url;
            }
            ...
            public string GetBranchName(IRibbonControl control)
            {
                if (activeWorkbookBranch == null)
                    return "";
                return "Branch: " + activeWorkbookBranch.DisplayName;
            }

            public string GetLastModified(IRibbonControl control)
            {
                if (activeWorkbookBranch == null)
                    return "";
                return "Last modified: " + activeWorkbookBranch.LastModified;
            }
