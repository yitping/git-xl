    ...
    public class Branch
    {
        ...
        public string BranchId
        {
            get
            {
                ...
                //TODO: this should be a function of the filename at first commit
        ...
        private string GetStagingBranchName()
        {
            return StagingBranchPrefix + BranchId + "__" + Name;
        }
        ...
        public Branch Checkout()
        {
            ...
            var stagingBranchName = GetStagingBranchName();
        ...
        public string LastModified
        {
            get
            {
                return GetHeadCommit().Author.When.ToLocalTime().DateTime.ToString("MMMM dd, yyyy, HH:MM:ss");
            }
        }
        ...
        public string Description
        {
            get
            {
                ...
                if (!IsStagingBranch)
                {
                    return DisplayName + " [last modified by " + head.Author.Name + ", " + LastModified + "]" + (HasConflict ? "*" : "");
                }
