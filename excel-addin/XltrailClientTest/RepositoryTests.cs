...
namespace Xltrail.Client.Test
{
    class RepositoryTests
    {
        ...
        private void CopyWorkbook(string source, string target)
        {
            ...
            File.Copy(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", source), target, true);
        }
        ...
        [Test]
        public void TestCanDiscardCheckout()
        {
            var repository = new Repository(path);
            var workbook = repository.GetWorkbooks("xlwings/tests").First();
        ...
        public void TestConflict()
        {
            ...
            stagingBranch.Commit(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "Book1_v3.xlsx"), "username", "name@user.com");
            Assert.IsTrue(branch.HasConflict);
